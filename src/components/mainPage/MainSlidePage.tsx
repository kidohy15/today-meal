    ...
    <div className="relative h-full">
      ...
      >
        <SwiperSlide>
          ...
          <div className="absolute bottom-[10%] w-[260px] right-[50%] mr-[-130px] lg:left-10 flex flex-col items-center justify-center z-20 ">
        ...
        <SwiperSlide>
          <div className="relative flex flex-col justify-center h-full w-full bg-[url('/images/peking-roast-duck-recipe-food-on-dish-ai-generated_848903-845.avif')] bg-cover p-1 overflow-hidden">
            ...
            <div className="relative hidden sm:flex flex-wrap w-[980px] w-max-[1180px] mx-auto justify-center gap-8 mt-16 p-8 bg-[#f4f4f4] z-10">
              <div className="bg-white w-[420px] h-[100px] rounded-lg text-center leading-[112px] text-xl font-semibold">
                <p className="whitespace-pre-wrap">
                  <span className="text-green-500">OpenAI</span>를 통한 다양한
                  레시피 제공!
                </p>
              </div>
              <div className="bg-white w-full sm:w-[420px] h-[100px] rounded-lg text-center leading-[112px] text-xl font-semibold">
                <p className="whitespace-pre-wrap">
                  냉장고 <span className="text-green-500">남은 재료</span> 걱정
                  노노
                </p>
              </div>
              <div className="bg-white w-[420px] h-[100px] rounded-lg text-center leading-[50px] text-xl font-semibold">
                <p className="whitespace-pre-wrap">
                  AI 를 능가하는
